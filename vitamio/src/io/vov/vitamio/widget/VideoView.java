...
public class VideoView extends SurfaceView implements MediaController.MediaPlayerControl {
    ...
    private void initVideoView(Context ctx) {
        ...
        //获取屏幕尺寸
        scrrenWith = mContext.getResources().getDisplayMetrics().widthPixels;
        scrrenHeigh = mContext.getResources().getDisplayMetrics().heightPixels;
    }
    ...
    private int scrrenWith;
    private int scrrenHeigh;
    ...
    public void switchSecrren(){
        LayoutParams layoutParams = getLayoutParams();
        if(isFullScrren){
            layoutParams.width=defaultWidth;
            layoutParams.height=defaultHeight;
        }else{
            layoutParams.width=scrrenWith;
            layoutParams.height=scrrenHeigh;
        }
        requestLayout();
        isFullScrren=!isFullScrren;
    }
